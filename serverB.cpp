...
static const int BACKEND_PORT = SERVERB_UDP_PORT;
static const char *BLOCK_FILE = SERVERB_BLOCK_FILE;
...
int main() {
    ...
    // Construct server B's IP address structure
    ...
    std::cout << "The ServerB is up and running using UDP on port " << BACKEND_PORT << "." << std::endl;
    ...
    while (true) {
        ...
        std::cout << "The ServerB received a request from the Main Server." << std::endl;
        ...
        std::cout << "The ServerB finished sending the response to the Main Server." << std::endl;
    }
