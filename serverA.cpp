...
static const int BACKEND_PORT = SERVERA_UDP_PORT;
static const char *BLOCK_FILE = SERVERA_BLOCK_FILE;
...
int main() {
    ...
    // Construct server A's IP address structure
    ...
    std::cout << "The ServerA is up and running using UDP on port " << BACKEND_PORT << "." << std::endl;
